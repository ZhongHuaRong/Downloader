...
Item {
    ...
    function removeTask(index,toDownload){
    ...
    Settings{
        id:settings
        property alias trashUrl: page.urlList
        property alias trashPath: page.pathList
        property alias trashName: page.nameList
        property alias trashNum: page.numList
        property alias trashFiles: page.finishList
        property alias trashTotal: page.totalList
        property alias trashProgress: page.progressList
    }
